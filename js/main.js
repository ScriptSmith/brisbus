...
import { initializeWorker, requestFromWorker as workerRequest, postToWorker, terminateWorker } from './worker-client.js';
...
const {
  ...
  FOLLOW_MODE_ZOOM,
  FOLLOW_MODE_PITCH,
  FOLLOW_MODE_INITIAL_BEARING,
  ANIMATION_DURATION_MS,
  SLIDESHOW_INTERVAL_MIN_SECONDS,
  SLIDESHOW_INTERVAL_MAX_SECONDS,
  SLIDESHOW_INTERVAL_DEFAULT_SECONDS,
  SLIDESHOW_INTERVAL_STEP_SECONDS,
  ROTATION_FULL_CYCLE_SECONDS,
  ROTATION_SPEED,
  FOLLOW_MODE_FLY_DURATION_MS,
  FOLLOW_MODE_FLY_BUFFER_MS,
  CIRCLE_TRANSITION_DURATION_MS,
  UI_UPDATE_INTERVAL_MS,
  MAX_SEGMENT_DIFF,
  MAX_REASONABLE_DISTANCE,
  SNAP_THRESHOLD_M,
  DISTANCE_INTERVALS_SECONDS,
  SPEED_STATIONARY,
  SPEED_SLOW,
  SPEED_MEDIUM,
  SPEED_FAST,
  ...
  THIRTY_MINUTES_MS,
  DEFAULT_ROUTE_TYPE,
  DEFAULT_VEHICLE_EMOJI,
  VEHICLE_DISPLAY_MODES,
  ROUTE_TYPE_TO_CHAR,
  EMOJI_CANVAS_SIZE,
  CHAR_CANVAS_SIZE,
  ROUTE_LINE_COLOR,
  ...
  STOP_CIRCLE_OPACITY,
  USER_LOCATION_RADIUS,
  USER_LOCATION_COLOR_LIGHT,
  USER_LOCATION_COLOR_DARK,
  USER_LOCATION_OPACITY,
  USER_LOCATION_STROKE_WIDTH,
  USER_LOCATION_STROKE_COLOR_LIGHT,
  USER_LOCATION_STROKE_COLOR_DARK,
  TRAIL_LINE_WIDTH,
  TRAIL_LINE_OPACITY,
  COLOR_STATIONARY,
  COLOR_SLOW,
  ...
  STOPS_MIN_ZOOM,
  HALF_INTERVAL_MS,
  INACTIVE_VEHICLE_THRESHOLD_MS,
  STOP_CLUSTER_RADIUS,
  STOP_CLUSTER_MAX_ZOOM,
  MAX_DEBUG_LOGS,
  LIGHT_MAP_STYLE,
  DARK_MAP_STYLE,
  FILTER_DEBOUNCE_MS,
...
// Wrapper functions for lockUI/unlockUI that will be defined after interactiveElements
let interactiveElements = []; // Will be populated later

function lockUI() {
  uiLockUI(interactiveElements);
}

function unlockUI() {
  uiUnlockUI(interactiveElements);
}

function applyStats(stats) {
  uiApplyStats(stats, gtfsStats);
}
...
// Note: Many UI functions are now imported from ui.js module
// Some elements are duplicated here for backward compatibility during refactoring

// Get UI element references first (many are imported from ui module, some duplicated here)
const debugLogs = []; // Local debug logs array
